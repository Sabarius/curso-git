...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
archivo_de_texto.txt            // Esto va a ignorar el archivo con ese nombre especifico
*.txt                           // Esto va a ignorar a todos los archivos que terminen con .txt
!este_archivo_si_subirlo.txt    // Este hará una escepción y aunque arriba hace que se ignoren todos los .txt este si se subirá
fotos/                          // Esto ignorará todo lo que este adentro de la carpeta "fotos"
!fotos/background.png           // Hará una escepción de lo que esta arriba y ese archivo especifico si lo subirá
